...
/**
 * This is the item provider adapter for a {@link fr.inria.kairos.influence.metamodel.EnvironmentalFactor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvironmentalFactorItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EnvironmentalFactorItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_EnvironmentalFactor_description_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EnvironmentalFactor_description_feature",
	...
	protected void addFlexibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EnvironmentalFactor_flexibility_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EnvironmentalFactor_flexibility_feature",
						"_UI_EnvironmentalFactor_type"),
				MetamodelPackage.Literals.ENVIRONMENTAL_FACTOR__FLEXIBILITY, true, false, false,
				ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns EnvironmentalFactor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EnvironmentalFactor"));
	}
	...
	public String getText(Object object) {
		String label = ((EnvironmentalFactor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_EnvironmentalFactor_type")
				: getString("_UI_EnvironmentalFactor_type") + " " + label;
	}
