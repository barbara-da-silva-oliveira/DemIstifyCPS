 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.kairos.influence.metamodel.impl.SystemResponseImpl#getObservation <em>Observation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemResponseImpl extends MinimalEObjectImpl.Container implements SystemResponse {
	...
	public void setObservation(String newObservation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.SYSTEM_RESPONSE__OBSERVATION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MetamodelPackage.SYSTEM_RESPONSE__OBSERVATION:
