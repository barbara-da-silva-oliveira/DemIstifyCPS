 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.kairos.influence.metamodel.impl.RequirementSatisfactionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.inria.kairos.influence.metamodel.impl.RequirementSatisfactionImpl#getConcerningRequirement <em>Concerning Requirement</em>}</li>
 *   <li>{@link fr.inria.kairos.influence.metamodel.impl.RequirementSatisfactionImpl#getSatisfaction <em>Satisfaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementSatisfactionImpl extends MinimalEObjectImpl.Container implements RequirementSatisfaction {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.REQUIREMENT_SATISFACTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.REQUIREMENT_SATISFACTION__NAME,
					oldName, name));
	}
	...
	public void setConcerningRequirement(String newConcerningRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MetamodelPackage.REQUIREMENT_SATISFACTION__CONCERNING_REQUIREMENT, oldConcerningRequirement,
	...
	public EList<String> getSatisfaction() {
		if (satisfaction == null) {
			satisfaction = new EDataTypeUniqueEList<String>(String.class, this,
					MetamodelPackage.REQUIREMENT_SATISFACTION__SATISFACTION);
		}
		return satisfaction;
	}
