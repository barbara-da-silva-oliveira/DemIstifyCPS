...
/**
 * This is the item provider adapter for a {@link fr.inria.kairos.influence.metamodel.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_name_feature",
								"_UI_Artifact_type"),
						MetamodelPackage.Literals.ARTIFACT__NAME, true, false, false,
	...
	protected void addRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Artifact_ref_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_ref_feature",
								"_UI_Artifact_type"),
						MetamodelPackage.Literals.ARTIFACT__REF, true, false, true, null, null, null));
	}
