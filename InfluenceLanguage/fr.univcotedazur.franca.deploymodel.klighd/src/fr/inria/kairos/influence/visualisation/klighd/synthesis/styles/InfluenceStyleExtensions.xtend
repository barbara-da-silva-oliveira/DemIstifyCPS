 ...
 */
@ViewSynthesisShared
class InfluenceStyleExtensions extends AbstractSynthesisExtensions {
...
//	def KContainerRendering addEnvIcon(KContainerRendering parent) {
//		return parent.addRectangle() => [
//			invisible = true
//			var KImage img = KRenderingFactory.eINSTANCE.createKImage();
//			img.imagePath = value
//			addPolygonClip(KGraphFactory.eINSTANCE.cre)ygone(CLOUD_WIDTH / 7, CLOUD_WIDTH / 7) => [
//				background = Colors.GRAY
//				foreground = Colors.GRAY
//				setPointPlacementData(LEFT, 2, 0, TOP, 0, 0.5f, H_LEFT, V_TOP, 0, 0, CLOUD_WIDTH, CLOUD_WIDTH / 3)
//			]
